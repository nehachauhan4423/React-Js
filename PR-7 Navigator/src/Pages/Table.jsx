                                    ...
                                    record.map((u, i) => {
                                        ...
                                        return (
                                            <tr key={i}>
                                                ...
                                                <td>
                                                    <span onClick={() => userDelete(id)}><i><MdDeleteSweep style={{ color: 'orange' }} /></i></span>

                                                    <span onClick={() => navigate(`/edit`, { status: u })}><i><MdDeleteSweep style={{ color: 'blue' }} /></i></span>
                                    ...
                                    filterData.map((u,i)=>{
                                        ...
                                        return(
                                            <tr key={i}>
                                                ...
                                                <td>
                                                    <span onClick={()=>userDelete(id)}><i><MdDeleteSweep style={{color:"orange"}}/></i></span>
                                                    <span onClick={()=>navigate(`/edit`,{state :u})}><i><MdDeleteSweep style={{color:"blue"}}/></i></span>
                                                </td>
                                            </tr>
                                        )
                                    })
