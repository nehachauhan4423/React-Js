...
const Table = () => {
    ...
    useEffect(() => {
        let filtered = [...record]; // Use 'record' here instead of 'allusers'
    ...
    }, [status, search, sort, record]); // Dependency on 'record'
                    ...
                    {filterData.map((u) => {
                        ...
                        return (
                            <tr key={id}>
                                ...
                                <td>{name}</td>
                                <td>{email}</td>
                                <td>{Array.isArray(cities) && cities.length ? cities.join(", ") : "Surat"}</td>
                                <td>{designation}</td>
                                <td>{salary}</td>
                                <td>{date}</td>
                                <td>
